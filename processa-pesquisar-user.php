...
<body>
    ...
    $nomeChocolate = $_POST["pesquisar"];

    $sql = "SELECT * FROM tbchocolates WHERE ingredientes LIKE '%$nomeChocolate%'";
    ...
    //contar o numero de linhas devolvidas
